...
class BlockAuthorForm extends ContentEntityConfirmFormBase {
  ...
  public function submitForm(array &$form, FormStateInterface $form_state) {
    ...
    $this->connection->insert('ptalk_block_user')
      ->fields(array(
        'author' => $author->id(),
    ...
    $this->messenger()->addMessage($this->t('@author has been blocked from sending you any further messages.', ['@author' => ptalk_participant_format($author), ['plain' => TRUE]]));
  }
